...
public class ElasticBulkProcessorFactory extends AbstractFactoryBean<BulkProcessor> {
    ...
    private XContentBuilder createRequestMapping() throws IOException {
        return XContentFactory.jsonBuilder()
                    ...
                    .startObject("geoip")
                        .startObject("properties")
                        .startObject("continent_name").field(FIELD_TYPE, FIELD_TYPE_KEYWORD).endObject()
                        .startObject("country_iso_code").field(FIELD_TYPE, FIELD_TYPE_KEYWORD).endObject()
                        .startObject("region_name").field(FIELD_TYPE, FIELD_TYPE_KEYWORD).endObject()
                        .startObject("city_name").field(FIELD_TYPE, FIELD_TYPE_KEYWORD).endObject()
