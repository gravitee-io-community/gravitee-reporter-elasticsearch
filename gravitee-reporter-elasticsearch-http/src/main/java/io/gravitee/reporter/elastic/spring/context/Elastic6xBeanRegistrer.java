...
import io.gravitee.reporter.elastic.indexer.es6.ES6BulkIndexer;
import io.gravitee.reporter.elastic.indexer.name.SingleTypeIndexNameGenerator;
import io.gravitee.reporter.elastic.mapping.ES6IndexPreparer;
...
public class Elastic6xBeanRegistrer {
    ...
    public void register(DefaultListableBeanFactory beanFactory) {
        ...
        BeanDefinitionBuilder beanIndexNameGenerator = BeanDefinitionBuilder.rootBeanDefinition(SingleTypeIndexNameGenerator.class);
